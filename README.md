...
| [manifesto](manifesto/) | Create concentrated manifesto declarations and bind Claude behavior to... | `3.1.1` | 2S |
| [orchestration](orchestration/) | Agent delegation framework, multi-agent research orchestration, and session... | `3.4.1` | 4S |
...
## [orchestration](orchestration/) `3.4.1`
