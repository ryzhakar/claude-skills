...
- **[qa-orchestration](qa-automation/skills/qa-orchestration/SKILL.md)** `2.1.0` — Extension of agentic-delegation for the Playwright test lifecycle. Adds the Plan→Generate→Execute→Heal→Report loop, four-agent...
### Agents
