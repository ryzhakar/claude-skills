...
For detailed slicing techniques, see @references/slicing.md — it covers SPIDR decomposition methods (Spike, Paths, Interface, Data, Rules), workflow slicing, data lifecycle slicing, and interface fidelity slicing with validation order guidelines.
...
For detailed anti-patterns and remedies, see @references/anti-patterns.md — it covers template worship, technical stories, epics in disguise, componentized stories, orphan cards, implementation leaks, moving targets, and checkbox AC with diagnosis and cure for each.
