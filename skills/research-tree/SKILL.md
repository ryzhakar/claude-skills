...
Not every research needs all tiers. Quick scans skip Tier 3-4. Deep assessments use all six. See `references/tier-playbook.md` for skip conditions and heuristics.
...
See `references/agent-templates.md` for domain-adaptable skeletons.
...
The three most damaging (see `references/anti-patterns.md` for the full catalog of 10):
...
- @references/tier-playbook.md — tier definitions, skip conditions, agent count heuristics, completion gates
- @references/anti-patterns.md — 10 failure modes with detection strategies and fixes
- @references/agent-templates.md — domain-adaptable prompt skeletons for every agent type
- @references/report-formats.md — standardized templates for every report type
- `examples/awesome-leptos-session.md` — worked example: software ecosystem research (Rust/Leptos, 98 entries, 22 agents, 5 tiers)
